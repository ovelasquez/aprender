...
class CoursesType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('place', ChoiceType::class, array('choices' => array($options['locations'][0] => '1', $options['locations'][1] => '2'), 'required' => true, 'placeholder' => 'Seleccione', 'attr' => array('class' => 'form-control')))
                ...
                ->add('minstudent', TextType::class, array('required' => true, 'attr' => array('class' => 'form-control',)))
                ->add('maxstudent', TextType::class, array('required' => true, 'attr' => array('class' => 'form-control',)))
